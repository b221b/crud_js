...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 17 2024 г., 15:01
...
(1, 'Фирма xpfxz', 234567890, 'xpfxz@gmail.com', 'www.xpfxz.com', 'Ростов-на-Дону', 1),
(2, 'грустно', 987654321, 'updated@example.com', 'updated.com', 'Ростов-на-Дону', 0),
(3, 'однако', 876543210, 'firma3@example.com', 'www.firma3.com', 'Пермь', 0),
(4, 'без', 123456789, 'firma4@example.com', 'www.firma4.com', 'Воронеж', 0),
(5, 'лучшего', 678901234, 'firma5@example.com', 'www.firma5.com', 'Азов', 0),
(6, 'друга(', 991827750, 'Firma6@example.com', 'www.firma6.com', 'Москва', 0),
...
(36, 'invokergirl', 13371, 'invokergirl@gmail.com', 'invokergame.com', 'Dota', 1),
(43, 'invokergirl', 13371, 'invokergirl@gmail.com', 'invokergame.com', 'Dota', 1);
...
CREATE TABLE `roles` (
  ...
  `permissions` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
